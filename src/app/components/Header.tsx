...
const Header = (props: Props) => {
  return (
    <div className="hero-section flex flex-col xl:items-start sm:items-center w-screen">
      ...
      <p className='cursor-default text-sm xl:text-xl w-fit bg-white p-2 m-2 md:m-0 border-2 sm:max-w-full md:max-w-xl border-black xl:shadow-inherit lg:shadow-[10px_10px_0px_0px_#000] hover:shadow-[10px_10px_0px_0px_#000] duration-150 ease-out'>Helping designers on recources with 11.2k+ copies trough <Link href="https://www.figma.com/@muhamaddigdaya" className='underline hover:font-bold' target='_blank'>Figma Community</Link></p>
    </div>
  )
}

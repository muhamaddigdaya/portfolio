...
const Featured = (props: Props) => {
  return (
    <div className='flex flex-col items-start sm:items-center mt-8 ml-0 p-8 bg-[#FFF59F] border-8 border-black sm:border-4 w-fit space-y-8 hover:shadow-[10px_10px_0px_0px_#000] xl:shadow-inherit lg:shadow-[10px_10px_0px_0px_#000] duration-150 ease-in text-black'>
